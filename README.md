...
The cmd.Cmd class also provides default command handling and special command handling for commands such as help, quit, and EOF, which can be customized by defining corresponding do\_ methods with the same names.
